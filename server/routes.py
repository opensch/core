...
routingMap = {
    ...
    "privAPI/getClassesTimetable": {"method": ["GET"], "function": timetable.get_class_timetable},
    "privAPI/cabinet": {"method": ["GET", "POST", "DELETE"], "function": cabinet.private_handler},
    "privAPI/lesson": {"method": ["GET", "POST", "DELETE"], "function": lesson.private_handler},
    "privAPI/replacement": {"method": ["GET", "POST", "DELETE"], "function": replacement.private_handler},
    "privAPI/news": {"method": ["PUT", "POST", "DELETE"], "function": cdn.private_handler}
}
